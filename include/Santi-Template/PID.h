 ...
 * update period is 10ms or 100Hz, but now that Santi (yes 3rd person for now) has added respect to dt
 * you can change the update period freely (but don't Gavin)
 */
